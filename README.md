...
현재 production overlay는 **644개 고유 idea_id**입니다. 배치·V8 fallback 사이의
중복 idea_id는 0개이며, DB 스키마가 아직 완성되지 않은 Batch 058–062·069–076의
...
V12 production DB에는 외부자료로 검증한 심층 사후분석 644건이 있습니다.
