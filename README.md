...
현재 production overlay는 **674개 고유 idea_id**입니다. 배치·V8 fallback 사이의
중복 idea_id는 0개이며, DB 스키마가 아직 완성되지 않은 Batch 058–062·072–076의
...
V12 production DB에는 외부자료로 검증한 심층 사후분석 674건이 있습니다.
...
Batch 071에서는 AGC closed-end fund, American General·Springleaf 선순위채 2건, AGCO,
Argentex, Agrify 2건, Alliance Gaming과 Alamos Gold 2건을 같은 0–12장 형식으로 재구성했습니다.
raw Short→Long 3건, debt security type 2건과 historical AGI 법인 mapping을 교정하고 CEF 할인·tender,
채권 maturity·exchange, derivatives collateral liquidity, vendor financing·reverse split, 광산 permit과
operating bottleneck을 각각 독립 claim과 payoff로 분리했습니다.
